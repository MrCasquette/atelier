...
- 75cc566: Les commandes du dépôt nomment leur produit (ADR-0066). Chaque produit possède sa pile Compose —
...
- 312be61: Un champ de texte riche s'édite enfin comme de la prose.
...
- 6bb465b: Reconstruit l'image du runtime depuis `main`. La `0.8.0` publiée sur GHCR ne correspond pas au code
