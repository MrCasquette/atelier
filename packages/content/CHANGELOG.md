...
- 2ecd3a5: `f.component(x)` et `f.list(x)` appelés **sans options** rendaient facultatifs les champs requis du
...
- 45759ce: Un component imbriqué peut être requis (ADR-0075). `f.component(of, méta)` déclare l'imbrication
...
- f1aa111: `defineDirective` — le vocabulaire d'authoring d'une prose.
