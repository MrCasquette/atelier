...
`@mrcasquette/content` — `defineContent` passe par deux surcharges au lieu d'un paramètre de type
...
`@echoppe/client` — le générateur du SDK vérifie que la spec OpenAPI téléchargée porte bien des
