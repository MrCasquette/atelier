...
|---|---|---|
| Échoppe — framework e-commerce | [Roadmap Échoppe](docs-internal/design/roadmap-echoppe.md) | [docs/roadmap.md](docs/roadmap.md) |
| Prisme — CMS headless config-as-code | [Roadmap Prisme](docs-internal/design/roadmap-prisme.md) | — |
...
trajectoire à lui, elle rejoindra `docs-internal/design/`, comme les deux produits.

## Ce qui n'est pas ici

Les tâches de V1 vivent dans les [backlogs](./BACKLOG.md). Les décisions vivent dans les
[ADR](docs-internal/adr/README.md), et l'instruction qui les précède dans `docs-internal/design/`.
